...
- Human owner: Gavi
- AI used: Claude
- [PR #66](https://github.com/eldaduz/CalcFlow/pull/66) merged and QA'd this update — see the dedicated PR #66 entry below for the full sequence (unintended merge, post-merge QA, Production deployment gap now resolved).
...
- **v1.0.0 status: everything is Done except CFL-31.** CFL-27/28/29/30/32/33 (and their children) all Done, verified live. Only remaining step toward v1.0.0 is Eldad executing the actual tag + GitHub Release (CFL-31), sequenced to come after everything else lands — which it now has.
- Next safe action: Eldad to execute CFL-31 (v1.0.0 release).
