...
4. **Gemini 3.1 Pro / High** — normal engineering, moderate state logic, long-context tasks (High is 3.1 Pro's standard level; it has no Medium)
...
- Prefer **Gemini 3.1 Pro / High** for normal engineering, integration, testing, QA, and long-context work. Use **Gemini 3.1 Pro / Low** only for the most mechanical tasks when 3.1 Pro is the approved model.
...
| Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium–High   |
...
| CFL-13 — Basic Calculator Interaction              | Gavi  | Gemini 3.5 Flash / Medium    | Gemini 3.1 Pro / High        | GPT-5.6 Luna / Medium                                                                         | GPT-5.6 Terra / Medium | State transitions interact incorrectly across multiple actions → Sonnet (AGY) / Terra High (Codex)                                        |
| CFL-14 — Expression Input and Editing              | Gavi  | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / High   | Expression-state design becomes coupled to parser architecture → Opus (AGY) / Sol High (Codex)                                            |
| CFL-16 — Expression Evaluation                     | Eldad | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | Planning, implementation, and unit tests: GPT-5.6 Terra / Medium; normal parser work included | GPT-5.6 Terra / Medium | Complex parser-safety or cross-Feature review and QA → Sonnet (AGY) / Terra High (Codex); Opus / Sol High only for genuinely complex risk |
| CFL-17 — Powers and Roots                          | Eldad | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / Medium | Domain, precision, or nth-root edge cases remain unresolved → Sonnet (AGY) / Terra High (Codex)                                           |
| CFL-18 — Logarithmic Functions                     | Gavi  | Gemini 3.5 Flash / Medium    | Gemini 3.1 Pro / High        | GPT-5.6 Luna / Medium                                                                         | GPT-5.6 Terra / Medium | Domain or parser-integration failures → Sonnet (AGY) / Terra High (Codex)                                                                 |
| CFL-19 — Trigonometric Functions                   | Eldad | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / Medium | Tangent tolerance, angle-mode contract, or cross-feature failure → Sonnet (AGY) / Terra High (Codex)                                      |
| CFL-20 — Angle Mode                                | Eldad | Gemini 3.5 Flash / Medium    | Gemini 3.1 Pro / High        | GPT-5.6 Luna / Medium                                                                         | GPT-5.6 Terra / Medium | Mode state is inconsistent across trigonometric functions → Sonnet (AGY) / Terra High (Codex)                                             |
| CFL-21 — Additional Scientific Operations          | Gavi  | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / Medium | Percentage semantics, factorial limits, or expression integration remain ambiguous → Sonnet (AGY) / Terra High (Codex)                    |
...
| CFL-24 — Keyboard Support                          | Gavi  | Gemini 3.1 Pro / High        | Claude Sonnet 4.6 (Thinking) | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / High   | Global shortcut, focus, or event-order bugs are difficult to isolate → Opus (AGY) / Sol High (Codex)                                      |
...
| CFL-27 — Application Logging                       | Eldad | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / Medium | Logging affects calculator behavior or unexpected failures are not isolated → Sonnet (AGY) / Terra High (Codex)                           |
...
| CFL-29 — Continuous Integration                    | Eldad | Gemini 3.1 Pro / High        | Gemini 3.1 Pro / High        | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / Medium | CI differs from local results or coverage enforcement is unstable → Sonnet (AGY) / Terra High (Codex)                                     |
...
| CFL-32 — Dependency Governance                     | Eldad | Gemini 3.1 Pro / High        | Claude Sonnet 4.6 (Thinking) | GPT-5.6 Terra / Medium                                                                        | GPT-5.6 Terra / High   | Security, maintenance, bundle, or dependency-tree risk is unclear → Opus (AGY) / Sol High (Codex)                                         |
